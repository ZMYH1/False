...
public class Skeletal extends Module {
    ...
    private final IntegerValue colorAlphaValue = new IntegerValue("Alpha", 200, 0, 255);
    ...
    public void onRender(Render3DEvent event) {
        ...
        for (int i = 0; i < playersLength; ++i) {
            ...
            if (!rainbow.get()){
                GL11.glColor4f(red.get() / 255.0f, green.get() / 255.0f, blue.get() / 255.0f, colorAlphaValue.get());
            }else {
