...
public class Blink extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        final Color color = breadcrumbs.getColorRainbow().get() ? ColorUtils.rainbow() : new Color(breadcrumbs.getColorRedValue().get(), breadcrumbs.getColorGreenValue().get(), breadcrumbs.getColorBlueValue().get());
