...
public class Animations extends Module {
    ...
    //some ListValue
    public static final ListValue Sword = new ListValue("PresetAnimationSword", new String[]{
            "Normal","SlideDown1", "SlideDown2" , "Slide",
            "Minecraft", "Avatar", "Tap1", "Tap2",
            "Poke", "Push1", "Push2" , "Up" ,
            "Shield", "Akrien", "VisionFX", "Swong",
            "SigmaOld", "ETB", "Rotate360", "SmoothFloat",
            "Strange" , "Reverse", "Zoom", "Move",
            "Stab", "Jello"}, "Slide");
    ...
    public static final FloatValue itemPosX = new FloatValue("ItemPosX", 0.56F, -1f, 1f);
    public static final FloatValue itemPosY = new FloatValue("ItemPosY", -0.52F, -1f, 1f);
    public static final FloatValue itemPosZ = new FloatValue("ItemPosZ", -0.71999997F, -1f, 1f);

    //scale all items
    public static final FloatValue Scale = new FloatValue("Scale", 1f, 0f, 4f);
