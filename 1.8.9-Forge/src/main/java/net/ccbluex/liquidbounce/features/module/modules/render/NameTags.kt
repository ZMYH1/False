...
class NameTags : Module() {
    ...
    private val alpha = IntegerValue("Alpha",60,0,255)
    private val dis = BoolValue("Near big and far small",true)
    private val shadow = BoolValue("ShadowRect",true)
    ...
    private fun renderNameTag(entity: EntityLivingBase, tag: String) {
        ...
        glColor3f(0f,0f,0f)
        if (shadow.get()) {
            drawShadow(-width - 2F, -2f, 2 * width + 6f, fontRenderer.FONT_HEIGHT + 4F)
        }
