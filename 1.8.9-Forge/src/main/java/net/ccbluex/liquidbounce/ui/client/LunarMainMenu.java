...
public class LunarMainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.btnLunarOptions = new ImageButton("LUNAR SETTINGS", new ResourceLocation("lunar/icons/lunar.png"), this.width / 2 - 30, yPos);
        this.btnCosmetics = new ImageButton("LUNAR COSMETICS", new ResourceLocation("lunar/icons/cosmetics.png"), this.width / 2 - 15, yPos);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.Sfui35.drawCenteredString("LUNAR CLIENT", this.width / 2 - 0.25F, this.height / 2 - 18, new Color(30, 30, 30, 70).getRGB());
        Fonts.Sfui35.drawCenteredString("LUNAR CLIENT", this.width / 2, this.height / 2 - 19, -1);
        ...
        Fonts.Sfui35.drawString("Lunar Client 1.8.9 (liquidbounce)", 7, this.height - 11, new Color(255, 255, 255, 100).getRGB());
        Fonts.Sfui35.drawString(s, 810, this.height - 11, new Color(255, 255, 255, 100).getRGB());
