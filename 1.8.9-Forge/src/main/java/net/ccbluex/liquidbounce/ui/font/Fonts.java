...
public class Fonts {
    ...
    @FontDetails(fontName = "Regular Medium")
    public static GameFontRenderer fontRegular35;

    @FontDetails(fontName = "Regular Medium")
    public static GameFontRenderer fontRegular38;

    @FontDetails(fontName = "Regular Medium")
    public static GameFontRenderer fontRegular40;

    @FontDetails(fontName = "Comfortable 1")
    public static GameFontRenderer comfortable1;

    @FontDetails(fontName = "Comfortable 2")
    public static GameFontRenderer comfortable2;

    @FontDetails(fontName = "Tenacity")
    public static GameFontRenderer tenacity1;
    ...
    public static void loadFonts() {
        ...
        fontRegular35 = new GameFontRenderer(getFont("Roboto-Regular.ttf",35));
        fontRegular38 = new GameFontRenderer(getFont("Roboto-Regular.ttf",38));
        fontRegular40 = new GameFontRenderer(getFont("Roboto-Regular.ttf",40));
        comfortable1 = new GameFontRenderer(getFont("wqy_microhei.ttf",35));
