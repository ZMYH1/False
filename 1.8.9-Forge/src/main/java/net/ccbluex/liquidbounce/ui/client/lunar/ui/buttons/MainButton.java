...
public class MainButton {
	...
	public void drawButton(int mouseX, int mouseY) {
		...
		Fonts.Sfui35.drawCenteredString(this.text, this.x + this.width / 2 + 0.5F, this.y + (this.height - 4) / 2 + 0.5F, new Color(30, 30, 30, 50).getRGB());
		Fonts.Sfui35.drawCenteredString(this.text, this.x + this.width / 2, this.y + (this.height - 4) / 2, new Color(190, 195, 189).getRGB());
	}
